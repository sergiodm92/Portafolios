            ...
            <div className={styleAboutme.switchButton} >
                    ...
                    {lenguage===0? 
                        <div className={styleAboutme.text} >
                            <h3 className={styleAboutme.title}>Sobre mi </h3>
                            <p>
                            ...
                            Actualmente me encuentro aprendiendo nuevas tecnologías, diseño UX, idiomas y desarrollando proyectos de manera freelance, estoy 
                        ...
                        : 
                            <div className={styleAboutme.text}>
                            <h3 className={styleAboutme.title}>About me </h3>
                            <p>
                            ...
                            I am currently learning new technologies, UX design, languages and developing freelace projects, I am
