        ...
        <div className={styleAboutme.first}>
          ...
          <div className={styleAboutme.parrafo}>
            <p className={styleAboutme.parr}>
              ...
              <br />
              Me apasionada el codigo, los algoritmos, la resolución de
              problemas, pero también el diseño UI/UX, busco mejorar mi código
              haciendoló mas limpio y eficiente, disfruto aprender nuevas
              tecnologías y metodologias.
              <br />
              ...
              apasionó la programación y es por ello que me dedico desde 2020 a
              esto. Actualmente me encuentro desarrollando proyectos de manera
              freelance con un pequeño equipo de trabajo, y capacitandome
              continuamente. Estoy en busqueda de una empresa donde pueda crecer
              de manera profesional e introducirme en el mundo IT
            </p>
          </div>
        </div>
      </div>
