            ...
            <div className={styleHome.back}>
                <div className={styleHome.divHome}>
                    ...
                    <div className={styleHome.divButton}>
                        <a href={cv} download="Sergio David - Full Stack Web Developer - CV 2022.pdf">
                            <div>
                                <Button
                    ...
                    <div className={styleHome.links}>
                        ...
                        <ButtonRedes
                                img={"https://res.cloudinary.com/dk2al2urj/image/upload/v1664492964/MyPortfolio/logo_github_knnf2b.png"}
                            />
                        </a>
